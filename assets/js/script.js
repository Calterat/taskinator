...
const createTaskEl = (taskDataObj) => {
        ...
        if (taskDataObj.status === 'to do') {
            listItemsEl.querySelector("select[name='status-change']").selectedIndex = 0;
            tasksToDoEl.appendChild(listItemsEl);
        } else if (taskDataObj.status === 'in progress') {
            listItemsEl.querySelector("select[name='status-change']").selectedIndex = 1;
            tasksInProgressEl.appendChild(listItemsEl);
        } else if (taskDataObj.status === 'completed') {
            listItemsEl.querySelector("select[name='status-change']").selectedIndex = 2;
            tasksCompletedEl.appendChild(listItemsEl);
        }
